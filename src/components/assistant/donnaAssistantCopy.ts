...
export const DONNA_PUBLIC_TITLE = 'Academy Assistant'

/** Full label used in headers and aria-labels. */
export const DONNA_FULL_LABEL = 'Donna — Academy Assistant'
...
export const DONNA_ACTIVATION_HELP = 'Open Donna, then speak naturally. No wake word required.'
