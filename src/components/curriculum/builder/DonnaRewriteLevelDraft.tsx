...
/**
 * DonnaRewriteLevelDraft — Sprint 909
 *
 * Neutralized stub. Level rewrite drafts are not yet connected to the
 * academy_curriculum_overrides review pipeline.
 *
 * Previous version showed a false-positive "Rewrite draft queued for review"
 * success state after calling setSubmitted(true) with no server action behind it.
 * That has been removed (BUG-2 fix from QA_CURRICULUM_DRAFT_PIPELINE_908.md).
 *
 * When level rewrite drafts are wired to a real server action this component
    ...
    <div className="rounded-2xl border border-lime/20 bg-lime/[0.03] p-5 space-y-4">
      ...
      >
        ...
        <p className="text-[11px] text-text-muted leading-relaxed">
          Level rewrite drafts are not connected to review yet.
        </p>
      </div>
