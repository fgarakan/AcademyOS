...
export const ONBOARDING_OPERATOR: GuidedOperator = {
  ...
  outOfScope: [
    'I can\'t submit interview answers on behalf of the director',
    'I can\'t auto-select a setup mode',
    'I can\'t activate the academy without director confirmation',
    'I can\'t invite coaches or parents directly (requires director approval)',
  ],
...
export const CURRICULUM_OPERATOR: GuidedOperator = {
  ...
  outOfScope: [
    'I can\'t publish curriculum directly — director must approve in the review queue',
    'I can\'t move players between levels as part of a curriculum change',
    'I can\'t modify the official curriculum without a proposed_actions draft',
    'I can\'t delete curriculum levels (this is a platform-level action)',
  ],
...
export const TEMPLATE_OPERATOR: GuidedOperator = {
  ...
  outOfScope: [
    'I can\'t save a template without director review',
    'I can\'t assign a template to a session directly',
    'I can\'t schedule sessions as part of template creation',
  ],
...
export const SESSION_OPERATOR: GuidedOperator = {
  ...
  outOfScope: [
    'I can\'t submit official session results directly — coach must use the wrap-up flow',
    'I can\'t mark a session as complete without director review',
    'I can\'t move players between groups during session planning',
  ],
...
export const PLAYER_OPERATOR: GuidedOperator = {
  ...
  steps: [
    ...
    },
    {
      ...
      requiresApproval: true,
      approvalNote: 'Parent communications require director review. I never send messages directly.',
  ...
  outOfScope: [
    'I can\'t move a player to a new level without director approval',
    'I can\'t expose raw coach notes to parents or players',
    'I can\'t access player data from other academies',
    'I can\'t auto-send parent communications',
    'I can\'t delete or archive player records',
  ],
...
export const REVIEW_CENTER_OPERATOR: GuidedOperator = {
  ...
  steps: [
    ...
    },
    {
      ...
      donnaPrompt: "Approval is your click in the review queue — I can\'t approve on your behalf. When you click Approve, the change runs officially. When you click Reject, the proposal is discarded and nothing changes. I'll be here to explain any item you're uncertain about.",
      actionType: 'approval_route',
      actionId: 'approve_review_item',
      requiresApproval: true,
      approvalNote: 'The change runs only when the director explicitly clicks Approve. I never trigger it myself.',
  ...
  outOfScope: [
    'I can\'t approve review items — director must click Approve in the UI',
    'I can\'t reject items on behalf of the director',
    'I can\'t bulk-approve multiple items automatically',
    'I can\'t modify a proposed action after it has been submitted',
    'I can\'t see the content of rejected items after rejection',
  ],
  ...
  approvalRequired: true,
  approvalNote: 'All approvals are director-only. I navigate, explain, and route — I never execute approval.',
}
