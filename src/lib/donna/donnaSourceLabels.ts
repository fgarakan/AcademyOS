...
export const SOURCE_LABELS = {
  ...
  curriculumGates: buildSourceLabel('curriculum', 'player_gate_status', 'blocked_by_schema', 'insufficient', 'Migrations 041-060 not applied'),
  curriculumBottleneck: buildSourceLabel('curriculum', 'curriculumBottleneckLoader', 'partial', 'partial', 'Tag-based — full curriculum gate data pending migration'),
