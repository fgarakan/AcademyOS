...
const ACTIONS: Record<string, ProposedAction> = {
  ...
  go_to_attention_queue: {
    id: 'go_to_attention_queue',
    label: 'Open Attention Queue',
    type: 'navigate',
    risk: 'low',
    href: '/director/attention',
    description: 'View all priority items needing director attention',
    requiresApproval: false,
  },
}
...
const INTENT_ACTIONS: Record<string, string[]> = {
  ...
  players_needing_attention:     ['go_to_attention_queue', 'go_to_players', 'go_to_approvals'],
  stalled_players:               ['go_to_attention_queue', 'go_to_players', 'start_assessment'],
  overdue_assessments:           ['go_to_attention_queue', 'go_to_assessments', 'start_assessment'],
  due_assessments:               ['go_to_attention_queue', 'go_to_assessments', 'start_assessment'],
  ...
  pending_placements:            ['go_to_attention_queue', 'review_placements'],
  placement_overrides:           ['go_to_attention_queue', 'review_placements'],
  ...
  academy_attention_today:       ['go_to_attention_queue', 'go_to_approvals', 'go_to_players'],
  ...
  resume_onboarding:             ['go_to_attention_queue', 'go_to_onboarding_review', 'go_to_add_player'],
