        ...
        <Card>
                  ...
                  return (
                    <li key={p.player_id ?? i}>
                      <Link
                        ...
                        className="flex items-center gap-3 py-2 border-b border-border last:border-0 hover:bg-surface-raised transition-colors rounded-lg px-1 -mx-1 group"
                      >
          ...
          <CardFooter>
            <p className="text-text-muted text-xs">
              Tap a player to view their development snapshot and recent observations.
            </p>
          </CardFooter>
        </Card>
      </div>
