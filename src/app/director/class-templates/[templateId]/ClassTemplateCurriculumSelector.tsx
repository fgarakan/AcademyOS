...
export function ClassTemplateCurriculumSelector({ templateId, currentLevelId, levels }: Props) {
    ...
    <div className="space-y-2">
      ...
      {!selectedId && (
        <p className="text-[11px] text-text-muted">
          Assign a curriculum level so sessions generated from this template include curriculum context and coach cues.
        </p>
      )}
    </div>
  )
