...
// ---------------------------------------------------------------------------
// Director Dashboard — canonical route: /director/dashboard
// Replaces /director/kpi (now redirects here).
...
export default async function DashboardPage() {
  ...
  return (
    <div className="p-6 animate-fade-in space-y-6 max-w-5xl">
      {/* Header */}
      <div>
        <p className="page-eyebrow">Evidence Layer</p>
