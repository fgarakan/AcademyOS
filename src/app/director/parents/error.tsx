  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] gap-4 px-4">
      ...
      <div className="text-center space-y-1.5">
        <p className="text-base font-semibold text-text-primary">Failed to load parent communications</p>
        <p className="text-sm text-text-muted max-w-xs leading-relaxed">
          {error.message || 'Could not load parent communications data. Try again or return to the dashboard.'}
        </p>
      </div>
